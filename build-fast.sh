...
check_prod_config()
{
    ...
    for opt in CONFIG_CMD_MTD CONFIG_CMD_UBI CONFIG_CMD_UBIFS CONFIG_MTD CONFIG_DM_MTD CONFIG_MTD_SPI_NAND CONFIG_MTD_UBI CONFIG_ENV_IS_IN_SPI_FLASH CONFIG_ENV_REDUNDANT CONFIG_CMD_RUN; do
        grep -q "^$opt=y$" "$CFG" || {
